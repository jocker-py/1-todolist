...
export type TodolistsReducerType = Reducer<TodolistStateType, TodolistActionsType>;
export const todolistsReducer = (state = initialState, action: TodolistActionsType): TodolistStateType => {
  switch (action.type) {
    case "ADD_TODOLIST":
